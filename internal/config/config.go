...
// LoadFromFile loads the ./GoTenancy.json file as the default library configuration
...
//
// You may create a "GoTenancy.json" config file that will be automatically loaded
// at startup.
